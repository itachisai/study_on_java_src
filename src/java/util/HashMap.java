...
public class HashMap<K,V> extends AbstractMap<K,V>
    ...
    static final int hash(Object key) {
        int h;
        return (key == null) ? 0 : (h = key.hashCode()) ^ (h >>> 16); //hashcode 大于 size的高位 
        														//当只有高位不一样时，则这些hashcode会产生冲突，
        														// 所以将高位的bit 反应在低位中，通过异或高低位。
    }
    ...
    static final int tableSizeFor(int cap) {
        ...
        // cap -1 是为了防止 100 本来是2的幂次方 变成原来的两倍。
        //xor 1 的时候 最高位和次高位变为1，
        // 继续xor 2 时 最高 四位变为1
        // 4 最高 8位
        // 8 16 16 32.
    }
